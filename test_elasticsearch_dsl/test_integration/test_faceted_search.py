...
from elasticsearch5_dsl.faceted_search import FacetedSearch, TermsFacet, DateHistogramFacet, RangeFacet
...
def test_empty_search_finds_everything(data_client):
    ...
    assert [
        ('elasticsearch5_dsl', 40, False),
        ('test_elasticsearch_dsl', 35, False),
        ('elasticsearch5_dsl/query.py', 19, False),
        ('test_elasticsearch_dsl/test_search.py', 15, False),
        ('elasticsearch5_dsl/utils.py', 14, False),
        ('test_elasticsearch_dsl/test_query.py', 13, False),
        ('elasticsearch5_dsl/search.py', 12, False),
        ('elasticsearch5_dsl/aggs.py', 11, False),
        ('test_elasticsearch_dsl/test_result.py', 5, False),
        ('elasticsearch5_dsl/result.py', 3, False)
    ] == r.facets.files
